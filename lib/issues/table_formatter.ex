defmodule Issues.TableFormatter do
  ...
  header identifies a column, and those columns are extracted and printed from the rows.
  ...
  list containing lists of the data in each column. The `headers` parameter contains
  ...
  with + signs underneath the vertical bar separating columns
  ...
  @doc """
  Given a list containing rows of data, a list containing the header selectors, and a
  format string, write the extracted data using the format string
  """
